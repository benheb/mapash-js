Composer.LayersController = Ember.ArrayController.extend( Ember.Evented, {
      store: null,
      length: 0,
      content: [],
...
Composer.layersController = Composer.LayersController.create({
  store: Composer.LayerStore.create()
});
